                  ...
                  <div className='flex-col'>
                    ...
                    <label className='text-15 font-md font-semibold'>Do you want to include USPs?</label>
                        <div className='flex mt-2'>
                          ...
                          <div className="flex items-center h-12 pl-4 w-1/2 mr-2 border border-gray-200 rounded-md dark:border-gray-700">
                            <input
                              id="no-usp-radio"
                              type="radio"
                              name="no-usp"
                          ...
                          <div className="flex items-center h-12 pl-4 w-1/2 ml-2 border border-gray-200 rounded-md dark:border-gray-700">
                            <input
                      ...
                      <div>
                        ...
                        <select 
                        id="tov" 
                        className="bg-transparent border border-gray-200 text-gray-900 text-md rounded block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
...
{/* // Til emojis */}
                    ...
                    <h3 class="mt-3 mb-1 font-semibold text-lg text-gray-900 dark:text-white">Emojis?</h3>
