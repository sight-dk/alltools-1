            ...
            <div className='bg-white px-10 py-20 rounded-2xl drop-shadow-md border-1 border-grey-200 w-10/12 h-8/12'>
                ...
                <div className='mt-8'>
                    ...
                    <div className = "mt-8 flex flex-col gap-y-4">
                        <button className='active:scale-[.97] active: duration-75 hover:scale-[1.01 ease-in-out] transition-all py-3 rounded-md bg-gradient-to-tr from-green-300 to-blue-500 drop-shadow-md text-white text-14 font-bold'> Sign In </button>
