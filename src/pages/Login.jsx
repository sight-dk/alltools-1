            ...
            <div className='bg-white px-10 py-20 rounded-3xl border-2 border-grey-200'>
                ...
                <div className='mt-8'>
                    ...
                    <div className = "mt-8 flex flex-col gap-y-4">
                        ...
                        <button className='active:scale-[.97] active: duration-75 hover:scale-[1.01 ease-in-out] transition-all flex py-3 rounded-xl border-2 items-center justify-center gap-2'>
